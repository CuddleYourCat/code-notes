...
let next_month = moment().add(1, 'months');
pm.variables.set('next_month', next_month.format('YYYY-MM-DD'));
pm.variables.set('next_month_day_of_week', next_month.format('d'));
next_month = moment().add(1, 'months').endOf('month');
for (day = 1; day <= 31; day++) {
    let date = addWorkingDays(nextWorkingDay(next_month), 1);
    pm.variables.set(`next_month_${day}`, date.format('YYYY-MM-DD'));
    pm.variables.set(`next_month_${day}_day_of_week`, date.format('d'));
}

let twoMonths = moment().add(1, 'months').endOf('month');
pm.variables.set('in_two_months', twoMonths.format('YYYY-MM-DD'));
pm.variables.set('in_two_months_day_of_week', twoMonths.format('d'));
for (day = 1; day <= 31; day++) {
    let date = addWorkingDays(nextWorkingDay(twoMonths), 1);
    pm.variables.set(`in_two_months_${day}`, date.format('YYYY-MM-DD'));
    pm.variables.set(`in_two_months_${day}_day_of_week`, date.format('d'));
}

if (pm.variables.get('pslid') == 'royalfree') {
    const startOfNextMonth = moment().add(2, 'months').startOf('month');
    pm.variables.set('start_date', startOfNextMonth.format('YYYY-MM-DD'));
    pm.variables.set('start-date', startOfNextMonth.format('YYYY-MM-DD'));
} else {
    pm.variables.set('start_date', addWorkingDays(new moment(), 12).format('YYYY-MM-DD'));
    pm.variables.set('start-date', addWorkingDays(new moment(), 12).format('YYYY-MM-DD'));
}

let targetDate = moment();
pm.variables.set('today', targetDate.format('YYYY-MM-DD'));
pm.variables.set('today_day_of_week', targetDate.format('d'));
...
let oneMonthAgo = addWorkingDays(moment().add(-1, 'months'), 1);
console.log(`one month ago: ${oneMonthAgo}`);
pm.variables.set('last_month', oneMonthAgo.format('YYYY-MM-DD'));
pm.variables.set('last_month_day_of_week', oneMonthAgo.format('d'));
console.log(`one month ago: ${oneMonthAgo}`);
let lastMonth = oneMonthAgo.endOf('month').add(-1, 'months');
console.log(`one month ago: ${oneMonthAgo}`);
pm.variables.set('last_month_1', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_2', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_3', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_4', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_5', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_6', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_7', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_8', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_9', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_10', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_11', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_12', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_13', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_14', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_15', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_16', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_17', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_18', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_19', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_20', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_21', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_22', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_23', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_24', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_25', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_26', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_27', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_28', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_29', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_30', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
pm.variables.set('last_month_31', lastMonth.add(1, 'days').format('YYYY-MM-DD'));
